            ...
            <form action="" method="POST">
               ...
               <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     <input id="input_category_thumbnail" name="thumbnail" value="" type="text" class="form-control" placeholder="{{ trans('categories.form_control.input.thumbnail.placeholder') }}" readonly />
                  </div>
               </div>
               <!-- parent_category -->
               <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <textarea id="input_category_description" placeholder="{{ trans('categories.form_control.textarea.description.placeholder') }}" name="description" class="form-control" rows="3"></textarea>
               </div>
