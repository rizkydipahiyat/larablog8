         ...
         <div class="card-body">
            <form action="{{ route('categories.store') }}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <textarea id="input_category_description" placeholder="{{ trans('categories.form_control.textarea.description.placeholder') }}" name="description" class="form-control @error('description') is-invalid @enderror" rows="3">{{ old('description') }}</textarea>
                  @error('description')
                     <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                     </span>
